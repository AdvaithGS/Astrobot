...
'Step 7':['''Iterate Alignment For Final Correction
Step 7
...
**The JWST has released its first high-res images, which can be viewed at https://webb.nasa.gov/content/webbLaunch/deploymentExplorer.html#43 **''','https://webb.nasa.gov/content/webbLaunch/assets/images/mirrorAlignment/webbBluePrintFgsComposite1.42-2000px.jpg']
     }
def get_image():
    global db
    return db['latest']
