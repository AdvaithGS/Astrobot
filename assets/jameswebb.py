...
def get_james_webb():
  ...
  return elapsedTime,req["distanceEarthKm"],req["distanceL2Km"],round(req["percentageCompleted"],2),get_image(),str(req["speedKmS"]) + ' km/s',req["currentDeploymentStep"],req['tempC']
